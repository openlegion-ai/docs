...
| Unicode sanitization | Invisible character stripping at three choke points (user input, tool results, system prompt context) | Prompt injection via hidden Unicode |
